...
void Bus::bus_details()
{
    while (true) {
        ...
        case 2:
            ...
            break;
        case 3:
            return; // Return to the main Bus menu
        default:
...
void Booking_System::menu()
{
    ...
    cout << "\t\t\t\t\t 1.BOOKING" << endl;
    cout << "\t\t\t\t\t 2.BUS SEATS DETAILS" << endl;
    cout << "\t\t\t\t\t 3.SEARCH BOOKING RECORD" << endl;
    cout << "\t\t\t\t\t 4.UPDATE BOOKING RECORD" << endl;
    cout << "\t\t\t\t\t 5.DELETE BOOKING RECORD" << endl;
    cout << "\t\t\t\t\t 6.SHOW ALL BOOKING RECORD" << endl;
    cout << "\t\t\t\t\t 7.EXIT" << endl;
    cout << "\n\t\t\t\t\t Please Select An Option:";
    cin >> option;
    switch (option)
...
void Booking_System::bus_seatsdetails()
{
    system("cls");
    fstream file, file1;
...
void Booking_System::search_booking()
{
    system("cls");
    fstream file;
...
void Booking_System::update_booking()
{
    system("cls");
    fstream file, file1;
...
void Booking_System::del_booking()
{
    system("cls");
    fstream file, file1;
    int t_seats, t_amount, found = 0, del_seats, i = 0;
...
int main() {
    ...
    cout << "\n\n\t\t\t\t\t\t Password:";
    cin >> pass;
    if (email != "admin@superior" || pass != "12345") {
